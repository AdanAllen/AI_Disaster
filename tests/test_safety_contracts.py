    ...
    def test_risk_summary_renders_limitations_in_labeled_details(self):
        ...
        resident_plan = {
            ...
            "hazard_priorities": [{
                "slug": "flood",
                "hazard": "Flood",
                "mapped_finding_status": "data_unavailable",
                ...
                "mapped_finding_source_name": "Official flood layer",
                ...
                "successful_sources": [],
                "failed_sources": ["Official layer unavailable — not checked."],
                "address_specific_notes": "Official layer unavailable — not checked.",
                "plan_area": "Unknown",
                "boundary_warning": "",
                "sources_used": [],
                "limitations": ["Official layer unavailable — not checked."],
