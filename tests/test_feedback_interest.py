...
class FeedbackRouteTests(unittest.TestCase):
    ...
    def test_contextual_ctas_and_privacy_copy(self):
        ...
        self.assertIn("Share feedback or an opinion", home)
        self.assertIn("Give feedback", home)
        self.assertIn("Community organization inquiries", home)
        self.assertNotIn("Interested in using StayReady with your community", home)
